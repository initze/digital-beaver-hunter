...
parser.add_argument(
    ...
    type=str,
    required=True,
    default="/isipd/projects/Response/Restricted_Airborne/MACS/2021_Perma-X_Alaska/01_raw_data",
)
parser.add_argument(
    "--vector_suffix", type=str, required=True, default="footprints_full.shp"
)
